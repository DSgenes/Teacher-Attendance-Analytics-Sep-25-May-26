...
The dataset consisted of teacher attendance records containing the following attributes:

# Column Name	         Description
  CampusName	         Campus Location
  EmployeeID	         Employee Identifier
  FullName	           Teacher Name
  Designation	         Job Title
  AttendanceDate	     Daily Attendance Date
  MonthDate	           Month-Year Reference
  TimeIn	             Check-In Time
  TimeOut	             Check-Out Time
  InMarkedAt	         Attendance Marking Location
  OutMarkedAt	         Attendance Marking Location
  Status	             Attendance Status
  PresentFlag	         Present Indicator
  LeaveFlag	           Leave Indicator
  DayOffFlag	         Holiday Indicator
  Remarks	             Leave Category
  LateFlag	           Late Attendance Indicator
...
# 2. Late Attendance Analysis
- Employee-wise Late Count
...
- Month-wise Attendance Patterns
- Seasonal Attendance Behavior

# 5. Monthly Teacher Leave Analysis
- Employee-wise Leave Tracking

# 6. Monthly Leave Trend
- Organizational Leave Behavior
